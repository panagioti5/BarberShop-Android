...
public class CityShopsImpl implements ShopDAO {


    public List<Shop> getAllShopsByArea(Context context, String shopCity, int id) throws Exception {
        ...
        try {
            ...
            URL url = new URL(properties.getProperty("url") + properties.getProperty("allShopsURI") + Constants.SINGLE_SLASH + shopCity + Constants.SINGLE_SLASH + new Date().getTime() + Constants.SINGLE_SLASH + id);
